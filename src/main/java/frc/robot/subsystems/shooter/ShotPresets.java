...
public class ShotPresets {
  ...
  public static final Setpoints RED_FENDER = new Setpoints(29, 0, 0, 0.16);
  public static final Setpoints RED_FRONT_POST =
      new Setpoints(38, 0, 0.087, 0.12); // potentially make higher
  public static final Setpoints RED_SIDE_POST = new Setpoints(38, 0, 0.092, 0.098);
  ...
  public static final Setpoints RED_WING_POST = new Setpoints(49, 0, 0.0, 0.075);
