...
public abstract class RunAltAutoCommand extends Command {
  ...
  public RunAltAutoCommand(String name) {
    this.name = name;
  ...
  public RunAltAutoCommand addPath(String path, boolean isChoreo) {
  ...
  public RunAltAutoCommand addWait(double delay_s) {
    totalTime += delay_s;
